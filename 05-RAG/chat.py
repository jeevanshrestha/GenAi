...
#print(context)
SYSTEM_PROMPT = """
You are a helpful AI assistant that answers user questions based on the provided context retrieved from a PDF file along with page_contents and page_number.
